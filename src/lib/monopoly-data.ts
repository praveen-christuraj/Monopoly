...
export const BOARD_SPACES: BoardSpace[] = [
  ...
  {
    index: 1, name: "Guwahati", type: "property", price: 60,
  ...
  {
    index: 3, name: "Bhubaneshwar", type: "property", price: 60,
  ...
  {
    index: 5, name: "Chennai Central Station", type: "railroad", price: 200,
    rent: [25, 50, 100, 200], colorGroup: "railroad", mortgageValue: 100,
  },
  {
    index: 6, name: "Panaji (Goa)", type: "property", price: 100,
  ...
  {
    index: 8, name: "Agra", type: "property", price: 100,
    rent: [6, 30, 90, 270, 400, 550], houseCost: 50, colorGroup: "light-blue", mortgageValue: 50,
  },
  {
    index: 9, name: "Vadodara", type: "property", price: 120,
  ...
  {
    index: 11, name: "Ludhiana", type: "property", price: 140,
  ...
  {
    index: 13, name: "Patna", type: "property", price: 140,
    rent: [10, 50, 150, 450, 625, 750], houseCost: 100, colorGroup: "pink", mortgageValue: 70,
  },
  {
    index: 14, name: "Bhopal", type: "property", price: 160,
    rent: [12, 60, 180, 500, 700, 900], houseCost: 100, colorGroup: "pink", mortgageValue: 80,
  },
  {
    index: 15, name: "Howrah Station", type: "railroad", price: 200,
    rent: [25, 50, 100, 200], colorGroup: "railroad", mortgageValue: 100,
  },
  {
    index: 16, name: "Indore", type: "property", price: 180,
  ...
  {
    index: 18, name: "Nagpur", type: "property", price: 180,
    rent: [14, 70, 200, 550, 750, 950], houseCost: 100, colorGroup: "orange", mortgageValue: 90,
  },
  {
    index: 19, name: "Kochi", type: "property", price: 200,
  ...
  {
    index: 21, name: "Lucknow", type: "property", price: 220,
  ...
  {
    index: 23, name: "Chandigarh", type: "property", price: 220,
    rent: [18, 90, 250, 700, 875, 1050], houseCost: 150, colorGroup: "red", mortgageValue: 110,
  },
  {
    index: 24, name: "Jaipur", type: "property", price: 240,
    rent: [20, 100, 300, 750, 925, 1100], houseCost: 150, colorGroup: "red", mortgageValue: 120,
  },
  {
    index: 25, name: "New Delhi Station", type: "railroad", price: 200,
    rent: [25, 50, 100, 200], colorGroup: "railroad", mortgageValue: 100,
  },
  {
    index: 26, name: "Pune", type: "property", price: 260,
    rent: [22, 110, 330, 800, 975, 1150], houseCost: 150, colorGroup: "yellow", mortgageValue: 130,
  },
  {
    index: 27, name: "Hyderabad", type: "property", price: 260,
    rent: [22, 110, 330, 800, 975, 1150], houseCost: 150, colorGroup: "yellow", mortgageValue: 130,
  },
  {
  ...
  {
    index: 29, name: "Ahmedabad", type: "property", price: 280,
...
export const CHANCE_CARDS: GameCard[] = [
  ...
  { text: "Advance to Jaipur.", action: "move", destination: 24 },
  { text: "Advance to Ludhiana.", action: "move", destination: 11 },
  ...
  { text: "Take a trip to Chennai Central Station. Collect Rs 200 if you pass GO.", action: "move", destination: 5 },
  { text: "Take a drive to Mumbai.", action: "move", destination: 39 },
